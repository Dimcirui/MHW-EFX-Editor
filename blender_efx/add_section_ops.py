...
# ── 2026-08 补充：另外 10 个已 schema 化（field editing 已支持，见 extern_props.py）
# 但此前新建对话框选不到的 EXTERN 子类型模板。全部从 efx_samples/official 真实语料
# 提取的最小单类型 ExternAttribute（单 item），byte-perfect 自洽（_parse_extern
# 再 serialize() 与原始字节完全一致）。
# EXTERNEMITTERSHAPE3D  204B  来源：em001_200.efx
_BLANK_EXTERN_EMITTERSHAPE3D_B64 = ""  # noqa: E501
# EXTERNPLEMISSIVE  256B  来源：wp09_01_040.efx
_BLANK_EXTERN_PLEMISSIVE_B64 = ""  # noqa: E501
# EXTERNUVSEQUENCE  118B  来源：em115_100.efx
_BLANK_EXTERN_UVSEQUENCE_B64 = "dn6pGQAAAAABAAAAAAAAAMwo/3wCAAAAAgAAAAAAAAAAAAAAAAAAAAAAAAA/AAAAMzMzPwAAAAD2KHw/AAAAAAEAAAABAAAAAAAAAAAAAAAAAAAAAAAAAAA/AAAAAABAQAAAAAAAAIA/AAAAAAEAAAABAAAAAA=="  # noqa: E501
# EXTERNBILLBOARD3D  294B  来源：cm_hm_sauna_000.efx
_BLANK_EXTERN_BILLBOARD3D_B64 = ""  # noqa: E501
# EXTERNRGBWATER  350B  来源：em050_031.efx
_BLANK_EXTERN_RGBWATER_B64 = ""  # noqa: E501
# EXTERNVELOCITY3D0  124B  来源：em018_026.efx
_BLANK_EXTERN_VELOCITY3D0_B64 = "pgdIxQAAAAABAAAAAAAAAJZfzE8BAAAAAgAAAAAAAAAFAAAAAAAAAAcAAAADAAAAAAAAAAAAAAAZAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAFAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAUAAAAAAAAAAAAAAAAAAAAAAAAAA=="  # noqa: E501
# EXTERNVELOCITY3D1  750B  来源：em013_011.efx
_BLANK_EXTERN_VELOCITY3D1_B64 = ""  # noqa: E501
# EXTERNVELOCITY3D6  188B  来源：em013_091.efx（原文件该 ExternAttribute 混有其他类型
# item，此处只取该 type_hash 的单个 item 重新单独包一层 ExternAttribute，byte-perfect
# 自洽已验证）
_BLANK_EXTERN_VELOCITY3D6_B64 = "Wh+n9wAAAAABAAAAAAAAAIBUBHADAAAAAgAAAAAAAAAAAAAAzczMPs3MTD4AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAABI4Xo/CtejPAAAgD8AAAAAAACAPwAAAAAAAIA/AAAAAAAAAAAAAAAAAAAAAAAAAACamRk+zcxMPgAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAEjhej8K16M8AACAPwAAAAAAAIA/AAAAAAAAgD8AAAAAAAAAAAAAAAA="  # noqa: E501
# EXTERNMESH  382B  变长类型（每元素=mod3/mrl3 路径+固定字段），来源：cm_rapture_000.efx
_BLANK_EXTERN_MESH_B64 = ""  # noqa: E501
# EXTERNPTBEHAVIOR  87B  变长类型（每元素=EFX_Behavior，含具名行为字符串），来源：gm057_201_06.efx
_BLANK_EXTERN_PTBEHAVIOR_B64 = "pgdIxQAAAAABAAAAAAAAADY+/F8BAAAAAQAAAAAAAAAfAAAAAQAAAG5FZmZlY3Q6Ok1oRWZmZWN0RGVjYWxCZWhhdmlvcgCnRhKAr9tAQw8AAAD///+W"  # noqa: E501
...
_EXTERN_TYPE_B64 = {
    ...
    'EXTERNEMITTERSHAPE3D': _BLANK_EXTERN_EMITTERSHAPE3D_B64,
    'EXTERNPLEMISSIVE':     _BLANK_EXTERN_PLEMISSIVE_B64,
    'EXTERNUVSEQUENCE':     _BLANK_EXTERN_UVSEQUENCE_B64,
    'EXTERNBILLBOARD3D':    _BLANK_EXTERN_BILLBOARD3D_B64,
    'EXTERNRGBWATER':       _BLANK_EXTERN_RGBWATER_B64,
    'EXTERNVELOCITY3D0':    _BLANK_EXTERN_VELOCITY3D0_B64,
    'EXTERNVELOCITY3D1':    _BLANK_EXTERN_VELOCITY3D1_B64,
    'EXTERNVELOCITY3D6':    _BLANK_EXTERN_VELOCITY3D6_B64,
    'EXTERNMESH':           _BLANK_EXTERN_MESH_B64,
    'EXTERNPTBEHAVIOR':     _BLANK_EXTERN_PTBEHAVIOR_B64,
}
...
def add_extern(root_obj, extern_type='EXTERNSPAWN') -> bpy.types.Object:
    ...
    15 种可选子类型均已在 extern_props.py 里 schema 化，新建后可在 Extern Properties
    面板逐字段编辑（不再是纯 opaque 占位）；需配合 EXTERNREFERENCE 属性引用使用。
    """
...
class EFX_OT_add_extern(Operator):
    ...
    bl_description = ("Create a new Extern; a dialog lets you choose the subtype. "
                      "The new extern starts from a real-sample template and is field-editable.")
    bl_options     = {"REGISTER", "UNDO"}
    ...
    extern_type: EnumProperty(
        ...
        items=[
            ...
            ('EXTERNEMITTERSHAPE3D', "ExternEmitterShape3D", "Override 3D emitter shape parameters"),
            ('EXTERNPLEMISSIVE',  "ExternPlEmissive",  "Override particle emissive color parameters"),
            ('EXTERNUVSEQUENCE',  "ExternUvSequence",  "Override UV sequence animation parameters"),
            ('EXTERNBILLBOARD3D', "ExternBillboard3D", "Override 3D billboard parameters"),
            ('EXTERNRGBWATER',    "ExternRgbWater",    "Override RGB water color parameters"),
            ('EXTERNVELOCITY3D0', "ExternVelocity3D0", "Override velocity3D variant 0 parameters (low confidence field names)"),
            ('EXTERNVELOCITY3D1', "ExternVelocity3D1", "Override velocity3D variant 1 parameters (low confidence field names)"),
            ('EXTERNVELOCITY3D6', "ExternVelocity3D6", "Override velocity3D variant 6 parameters (low confidence field names)"),
            ('EXTERNMESH',        "ExternMesh",         "Override mesh (mod3/mrl3 reference) parameters"),
            ('EXTERNPTBEHAVIOR',  "ExternPtBehavior",   "Override particle behavior parameters"),
        ],
        default='EXTERNSPAWN',
    )
