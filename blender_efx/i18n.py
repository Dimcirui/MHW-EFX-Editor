...
STRINGS = {
    ...
    "sim.calib_hint":      {"EN": "Unconfirmed semantics — flip and compare in-game",
                            "ZH": "尚未实测确认的语义——切换后与游戏内对拍"},
    ...
    "sim.mesh_unbound":    {"EN": "No mod3 bound - these draw a placeholder box, "
                                  "so their shape and orientation mean nothing",
                            "ZH": "没绑 mod3，这些画的是占位方块——形状和朝向都不作数"},
