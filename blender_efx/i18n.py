...
STRINGS = {
    ...
    "colortool.align":        {"EN": "Hue Only",            "ZH": "仅修改色相"},
    "colortool.replace":      {"EN": "Replace All Colors",  "ZH": "直接替换全部"},
    "colortool.shifted":      {"EN": "Palette shifted toward target ({n} colors)",
                               "ZH": "色系已朝目标偏移（{n} 处颜色）"},
    "colortool.aligned":      {"EN": "Aligned {n} colors to target hue",
                               "ZH": "已将 {n} 处颜色对齐到目标色相"},
    "colortool.replaced":     {"EN": "Replaced {n} colors with target",
                               "ZH": "已将 {n} 处颜色替换为目标色"},
    "colortool.brightness_header":{"EN": "Brightness / Intensity", "ZH": "亮度 / 强度"},
    "colortool.brightness_mult":{"EN": "Multiplier",              "ZH": "乘数"},
    "colortool.brightness_apply":{"EN": "Apply Brightness",       "ZH": "应用亮度乘数"},
    "colortool.brightness_done":{"EN": "Multiplied {n} brightness fields by {m:.3f}",
                               "ZH": "已将 {n} 处亮度字段乘以 {m:.3f}"},
    "colortool.no_brightness":{"EN": "This EFX has no editable brightness fields",
                               "ZH": "该 EFX 没有可编辑的亮度字段"},
    "colortool.no_root":      {"EN": "No active Color Editor EFX selected",
                               "ZH": "未选中处于颜色模式的 EFX 文件"},
    "colortool.no_colors":    {"EN": "This EFX has no editable color fields",
                               "ZH": "该 EFX 没有可编辑的颜色字段"},
    "colortool.all_neutral":  {"EN": "All colors are neutral (no hue to shift)",
                               "ZH": "全部颜色都是中性色（没有可偏移的色相）"},
    "colortool.target_neutral":{"EN": "Target color has no distinct hue; pick a saturated color to shift",
                               "ZH": "目标颜色没有明确色相；请选一个有饱和度的颜色再偏移"},
    ...
    # ── 占位 / 通用 ──────────────────────────────────────────────────────────
    "attribute.opaque":          {"EN": "(read-only attribute)", "ZH": "（此属性暂为只读）"},
    "attribute.opaque_hint":     {"EN": "This attribute type is not available for editing yet.",
                              "ZH": "此属性类型暂不支持编辑。"},
    "attribute.partial_edit":    {"EN": "Some fields cannot be edited", "ZH": "部分字段暂不可编辑"},
    ...
    "sim.swing":           {"EN": "Simulate Swing", "ZH": "模拟挥砍"},
    "sim.display":         {"EN": "Display", "ZH": "显示"},
    "sim.perf":            {"EN": "Performance", "ZH": "性能"},
    "es3do.show":          {"EN": "Show Emitter Shape", "ZH": "显示生成区域"},
    "es3do.hide":          {"EN": "Hide Emitter Shape", "ZH": "隐藏生成区域"},
    "es3do.no_entry":      {"EN": "Select an effect body (or one of its attributes) first",
                            "ZH": "先选中一个特效体（或它下面的属性）"},
    "sim.frame":           {"EN": "Frame {0} / {1}", "ZH": "第 {0} / {1} 帧"},
    "sim.alive":           {"EN": "Alive {0}  ·  spawned {1}", "ZH": "存活 {0}  ·  累计生成 {1}"},
    "sim.pick_entry":      {"EN": "Select an EFX entry to simulate",
                            "ZH": "请先选中一个 EFX 特效体"},
    "sim.unsupported":     {"EN": "Not simulated (preview is incomplete)",
                            "ZH": "未模拟的属性（预览不完整）"},
    "sim.unsupported_n":   {"EN": "{0} attribute(s) are not simulated yet — see the panel list",
                            "ZH": "有 {0} 个属性尚未模拟——详见面板列表"},
    "sim.and_more":        {"EN": "… and {0} more", "ZH": "…还有 {0} 个"},
    "sim.err_no_entry":    {"EN": "No EFX entry under the active object",
                            "ZH": "当前对象上找不到 EFX 特效体"},
    "sim.err_no_attributes": {"EN": "This entry has no readable attributes",
                              "ZH": "该特效体没有可读取的属性"},
    ...
    "sim.uvs_grid":        {"EN": "No .uvs loaded — assuming a {0}x{1} grid",
                            "ZH": "未载入 .uvs——按 {0}×{1} 网格假设"},
    "sim.uvs_hint":        {"EN": "Load a .uvs on the UVSEQUENCE attribute for the real frames",
                            "ZH": "在 UVSEQUENCE 属性上载入 .uvs 才能用真实帧表"},
    "sim.uvs_cell":        {"EN": "Cell {0} / {1}  (group {2})",
                            "ZH": "第 {0} / {1} 格（第 {2} 组）"},
    "sim.uvs_noimage":     {"EN": "No sprite sheet bound — particles draw flat. "
                                  "Use Quick Load on the UVSEQUENCE attribute",
                            "ZH": "没绑序列帧大图，粒子只能画纯色——在 UVSEQUENCE 属性上用「一键载入」"},
    "sim.mesh_unbound":    {"EN": "No mod3 bound — shown as placeholder boxes; shape and orientation do not represent the actual effect",
                            "ZH": "未绑定 mod3，当前以占位方块显示；其形状和朝向不代表实际效果"},
    "sim.playing_n":       {"EN": "{0} entries playing together", "ZH": "{0} 个特效体同时播放"},
    "sim.children":        {"EN": "{0} child effect instance(s) (PtLife -> Action)",
                            "ZH": "{0} 个子特效实例（PtLife → Action）"},

    # ── UVSEQUENCE → .uvs → .tex 链式载入（uvs_link.py）──────────────────────────
    "uvslink.quick_load":  {"EN": "Quick Load", "ZH": "一键载入"},
    "uvslink.quick_load_all": {"EN": "All in this EFX", "ZH": "本 EFX 全部"},
    "uvslink.hint":        {"EN": "Loads the .uvs this attribute points at, plus its sprite sheet",
                            "ZH": "按本属性填的路径载入 .uvs，并尽量把序列帧大图一起载入"},
    "uvslink.need_editor": {"EN": "Sprite sheets need MHW Model Editor (.tex conversion); "
                                  "the .uvs itself loads either way",
                            "ZH": "序列帧大图需要 MHW Model Editor（负责 .tex 转换）；"
                                  ".uvs 本身无论如何都能载入"},
    "uvslink.done":        {"EN": "Loaded {0} .uvs file(s), {1} sprite sheet(s)",
                            "ZH": "已载入 {0} 个 .uvs、{1} 张序列帧大图"},
    "uvslink.failed":      {"EN": "{0} not fully loaded: {1}",
                            "ZH": "{0} 个未完全载入：{1}"},
    "uvslink.nothing":     {"EN": "Nothing loaded — check the Chunk Root",
                            "ZH": "什么都没载入——检查 Chunk Root"},
    "uvslink.no_root":     {"EN": "No EFX file collection for the active object",
    ...
    "uvslink.reason_uvs_read_failed":    {"EN": ".uvs unreadable", "ZH": ".uvs 读取失败"},
    "uvslink.reason_uvs_parse_failed":   {"EN": ".uvs unparseable", "ZH": ".uvs 解析失败"},
    "uvslink.reason_group_out_of_range": {"EN": "sequenceNo past the last group", "ZH": "sequenceNo 超出组数"},
    "uvslink.reason_no_tex_path":        {"EN": "that group has no texture path", "ZH": "该组没有贴图路径"},
    "uvslink.reason_tex_not_found":      {"EN": ".tex not on disk", "ZH": "磁盘上找不到 .tex"},
    "uvslink.reason_tex_convert_failed": {"EN": ".tex could not be converted", "ZH": ".tex 无法转换"},

    # ── 绑定网格驱动（mesh_drive.py）──────────────────────────────────────────
    "meshdrive.hint":       {"EN": "Drives the bound mod3 mesh object. For what the effect itself looks like, use Particle Simulation.",
                             "ZH": "驱动的是绑定的 mod3 网格对象。想看特效本身长什么样，用「粒子模拟」面板。"},
    "meshdrive.scope":      {"EN": "Scope", "ZH": "作用域"},
    "meshdrive.scope_all":  {"EN": "All bodies in this EFX", "ZH": "本 EFX 内所有特效体"},
    "meshdrive.drivers":    {"EN": "Drivers", "ZH": "驱动项"},
    "meshdrive.d_uv":       {"EN": "UV scroll (UVCONTROL)", "ZH": "UV 滚动（UVCONTROL）"},
    "meshdrive.d_timl":     {"EN": "Follow TIML animation", "ZH": "跟随 TIML 动画"},
    "meshdrive.d_place":    {"EN": "Static placement (TRANSFORM3D+MESH)", "ZH": "静态摆放（TRANSFORM3D+MESH）"},
    "meshdrive.start":      {"EN": "Start Mesh Drive", "ZH": "挂上驱动"},
    "meshdrive.stop":       {"EN": "Stop Mesh Drive", "ZH": "摘掉驱动"},
    "meshdrive.started":    {"EN": "Mesh drive on: {0}", "ZH": "驱动已挂上：{0}"},
    "meshdrive.none_started": {"EN": "Nothing started (check the drivers / selection)", "ZH": "没挂上任何项（检查勾选/选择）"},
    "meshdrive.stopped":    {"EN": "Mesh drive off", "ZH": "驱动已摘掉"},
    "meshdrive.stop_note":  {"EN": "Stopping only detaches the drivers. TIML edits are persistent either way.",
                             "ZH": "摘掉驱动只是解挂，不影响任何数据；TIML 的编辑本来就是持久的。"},
    ...
    "action.size_xyz":              {"EN": "Size XYZ", "ZH": "尺寸 XYZ"},
    "action.position_xyz":          {"EN": "Position XYZ", "ZH": "位置 XYZ"},
    "action.unkn_angles":           {"EN": "Unkn4-6 (angles?)", "ZH": "未知4-6（角度？）"},
    "action.unknown_fields":        {"EN": "Unknown Fields", "ZH": "未知字段"},
    "action.playefx_type":          {"EN": "Type (hash)", "ZH": "类型（哈希）"},
    "action.reimport_needed":       {"EN": "Imported before these fields existed — reimport to edit them (values are preserved on export either way)",
                                     "ZH": "本文件导入时这些字段还不存在——重新导入才能编辑（无论是否重新导入，导出都会原样保留原值）"},
    ...
    "extern.no_data":            {"EN": "No Extern data is available for this object", "ZH": "此对象没有可用的 Extern 数据"},
    "extern.reference_index":    {"EN": "Reference Index", "ZH": "引用索引"},
    "extern.dead_title":         {"EN": "Reference Index (invalid reference)", "ZH": "引用索引（无效引用）"},
    "extern.dead_line1":         {"EN": "This reference points outside the available Extern entries.",
                                  "ZH": "该引用指向了现有 Extern 条目范围之外。"},
    "extern.dead_line2":         {"EN": "Choose a valid target before editing it.",
                                  "ZH": "请先选择有效目标，再进行编辑。"},
    "extern.no_target_sentinel": {"EN": "No Target (-1 sentinel)", "ZH": "无目标（-1 哨兵）"},
    "extern.extern_object":      {"EN": "Extern Object",    "ZH": "Extern 对象"},
    "extern.dangling":           {"EN": "Reference target is missing; choose a valid target before export",
                                  "ZH": "⚠ 引用目标缺失；请在导出前选择有效目标"},
    ...
    "rootstate.hint":             {"EN": "At runtime, the game chooses which state fires; entries outside every table always fire",
                                   "ZH": "运行时由游戏选择触发哪个状态；不在任何表里的条目始终触发"},
    ...
    "material.no_slots":     {"EN": "No material slots", "ZH": "没有材质槽"},
    "material.unknown_schema": {"EN": "(unknown material type — no known texture slot list; showing existing entries only)",
                                 "ZH": "（未知材质类型，无已知贴图槽清单，仅显示已有条目）"},
    "material.main_type":    {"EN": "Main Material", "ZH": "主材质"},
    "material.name_field":   {"EN": "Material Name", "ZH": "材质名"},
    "material.other_params": {"EN": "Other Parameters", "ZH": "其它参数"},
    "material.name_unbound": {"EN": "Not bound to any material — has no effect in-game",
                               "ZH": "未绑定到任何材质——该材质槽游戏内不生效"},
    "material.bound_to":     {"EN": "Bound to", "ZH": "已绑定"},
    "material.pick_mrl3":    {"EN": "Reference .mrl3...", "ZH": "参考 .mrl3…"},
    "material.add_from_mrl3": {"EN": "Add from {src}", "ZH": "从 {src} 添加"},
    "attribute.not_registered":  {"EN": "Attribute data is unavailable. Reload the extension and try again.",
                              "ZH": "属性数据暂不可用。请重新加载扩展后重试。"},
    "ui.error_console":          {"EN": "This panel could not be displayed. See the system console for details.",
                              "ZH": "此面板无法显示。详情请查看系统控制台。"},
    "extern.data_unavailable":   {"EN": "Extern data is unavailable. Reload the extension and try again.",
    ...
    "timl.no_tracks_for_tlp":    {"EN": "No tracks are available for this timeline parameter", "ZH": "此时间线参数没有可添加的轨道"},
    "timl.add_to_a0":            {"EN": "Add TIML tracks for this field on A0 (Emission). Add them to A1 from the TIML sidebar.",
                                  "ZH": "为此字段在 A0（发射轴）添加 TIML 轨道。如需加到 A1，请在 TIML 侧栏手动添加。"},
    "timl.add_to_a1":            {"EN": "Add TIML tracks for this field on A1 (Lifetime). Add them to A0 from the TIML sidebar.",
                                  "ZH": "为此字段在 A1（寿命轴）添加 TIML 轨道。如需加到 A0，请在 TIML 侧栏手动添加。"},
    "timl.other_axis":           {"EN": "This attribute usually animates on {0}; the other axis may have no visible effect.",
                              "ZH": "此属性通常在 {0} 轴上制作动画；另一条轴可能不会产生可见效果。"},
